...
public class MavenCompiler {
	...
	public static void main(String[] args) throws IOException{
		...
		File src = new File("C:/Users/yazide/workspace/simu-generator/generated");
		File dest = new File("C:/Users/yazide/workspace/simu-generator/generated/target");
		mv.compile(src, dest);
		File src1 = new File("src");
		File path1 = new File("");
		File target  = new File("generated");
		FileTool.copyFilesRecursively(src1, path1, target);
		mv.initialize();*/
	}
}
